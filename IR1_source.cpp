//IR1 source with Monte Carlo simulation
//IR1_source.cpp
#include "IR.h"
#include "random.h"
#include "matrix.h"
...
IR_results IR::run_LIBOR_simulations() const
{
	...
	vector<double> FVprime(N+2); //numeric-rebased FV payment
	...
	//STEP 7: Compute Numerical-rebased Payment
